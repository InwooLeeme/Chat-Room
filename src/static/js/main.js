...
"use strict";var displayChat=document.querySelector(".chatDisplay"),jsForm=document.querySelector(".jsForm"),chatForm=document.querySelector(".chatForm"),typingBar=jsForm.querySelector("input"),displayMessage=function(e){var t=document.createElement("li");t.innerHTML='\n        <span class="author">You:'.concat(e,"</span>\n    "),displayChat.appendChild(t)},handleSubmit=function(e){e.preventDefault();var t=typingBar.value;typingBar.value="",displayMessage(t)};chatForm&&chatForm.addEventListener("submit",handleSubmit);
